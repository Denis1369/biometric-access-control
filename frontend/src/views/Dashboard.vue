...
/**
 * Аналитическая панель СКУД.
 *
 * Страница собирает данные журнала проходов и справочника отделов в понятные
 * отчёты: кто присутствует, кто опоздал, какие гости приходили и как менялась
 * активность по часам/дням. Здесь нет редактирования справочников: задача
 * страницы в том, чтобы руководитель или аналитик быстро получил картину дня.
 */
const ui = useUi()
