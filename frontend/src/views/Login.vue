 ...
 *
 * Пользователь вводит логин и пароль, backend возвращает JWT и данные роли, а
 * сервис авторизации сохраняет их в браузере. После успешного входа пользователь
 * переводится либо на страницу, куда он пытался попасть, либо на стартовый
 * раздел, подходящий его роли.
 */
const auth = useAuth()
