 ...
 * Страница проходной.
 *
 * Эта страница показывает рабочее место оператора КПП: выбранные камеры,
 * видеопотоки, последние события прохода и форму быстрого оформления гостевого
 * пропуска. Live-потоки идут через WebSocket и рисуются на canvas, а журнал
 * событий обновляется отдельной подпиской, чтобы оператор видел новые проходы
