...
<script setup>
/**
 * Заголовок страницы “План здания”.
 *
 * Здесь находятся действия верхнего уровня: создать здание, создать этаж или
 * загрузить план этажа. Они доступны только ролям, которым backend выдал право
 * редактировать техническую инфраструктуру.
 */
defineProps({
  canEditPlan: {
    type: Boolean,
