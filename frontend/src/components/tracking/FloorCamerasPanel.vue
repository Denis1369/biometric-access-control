...
<script setup>
/**
 * Панель просмотра размещённых камер выбранного этажа.
 *
 * Компонент ничего не редактирует: он показывает камеры, их координаты на плане
 * и признак наличия зоны видимости. При клике сообщает родителю, какую камеру
 * пользователь выбрал, чтобы Tracking.vue мог подсветить её на плане.
 */
defineProps({
  mappedCameras: {
    type: Array,
...
/** Отобразить относительную координату камеры `0..1` как процент на плане. */
